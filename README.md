# HRIS MSC — Antigravity Offline Source Workspace

## 1. Tentang repository ini

Repository ini merupakan **workspace dokumentasi, analisis, dan penyusunan perubahan source code HRIS MSC** yang dipindahkan secara manual dari generator lama ke Antigravity.
...
Repository ini **bukan salinan aplikasi Laravel lengkap**, bukan repository deployment, dan bukan environment runtime HRIS MSC.
...
- server development HRIS MSC;
- server production HRIS MSC;
- server QL;
...
Perubahan yang dibuat di dalam repository ini **tidak akan langsung mengubah aplikasi HRIS MSC**. Semua penerapan perubahan harus dilakukan secara sadar dan manual oleh programmer yang memiliki kewenangan pada generator, repository, database, atau server tujuan.
...
Walaupun source code HRIS MSC memiliki pola yang menyerupai Laravel, repository ini tidak dibangun sebagai project Laravel standar.
...
Tujuan utama repository ini adalah menyediakan peta source code yang rapi agar proses pemeliharaan HRIS MSC dapat dilakukan dengan lebih terstruktur.
...
Salah satu masalah awal HRIS MSC yang sedang dianalisis adalah error PostgreSQL:
...
workspace lokal
server ql
server development MSC
server production MSC
```
...
- fitur berhasil di server QL tetapi error di server MSC;
...
environment: server development MSC
...
> Repository ini adalah workspace source code offline untuk membantu programmer menganalisis dan menyiapkan perbaikan HRIS MSC menggunakan Antigravity.
>
...
>
> Tidak ada perubahan yang diterapkan otomatis ke sistem HRIS MSC.
>

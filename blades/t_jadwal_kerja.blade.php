      ...
      <hr>
        <!-- <div class="flex mt-2 justify-end">
          ...
          <div class="content-end flex">
            ...
            <button v-if="actionText" @click="generate(true)" type="button" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold ml-2 px-2 py-1 rounded flex items-center justify-cente">                <icon fa="bolt" size="sm mr-0.5"/> Generate
            </button>
          </div> -->
        </div>

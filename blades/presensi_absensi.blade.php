...
<div class="bg-white p-6 rounded-md">
 ...
 <FieldSelect class="w-full py-2 !mt-0" :bind="{ disabled: false, clearable:true }" :value="headerValues.dir_id"
      ...
      }" placeholder="Unit" fa-icon="search" :check="true" />
    ...
    <FieldSelect class="w-full py-2 !mt-0" :bind="{ disabled: false, clearable:true }" :value="headerValues.divisi_id"
      ...
      }" fa-icon="search" :check="true" placeholder="Jabatan" />
    ...
    <table class="table-auto w-full" v-if="openDateSelected && dataByDateDetail.length">
      <thead class="bg-blue-600 text-white ">
        <tr>
          ...
          <th class="border-1 border-gray-500 px-3 py-2 w-[10%]">ID</th>
          <th class="border-1 border-gray-500 px-3 py-2 w-[25%]">Nama</th>
          <th class="border-1 border-gray-500 px-3 py-2 w-[27%]">Unit</th>
          <th class="border-1 border-gray-500 px-3 py-2 w-[27%]">Jabatan</th>
          ...
          <th class="border-1 border-gray-500 px-3 py-2 w-[5%]">Foto Checkin</th>
          <th class="border-1 border-gray-500 px-3 py-2 w-[12%]">Alamat Checkin</th>
          <th class="border-1 border-gray-500 px-3 py-2 w-[12%]">Waktu Checkout</th>
          <th class="border-1 border-gray-500 px-3 py-2 w-[5%]">Foto Checkout</th>
          <th class="border-1 border-gray-500 px-3 py-2 w-[12%]">Alamat Checkout</th>
      ...
      <tbody class="bg-blue-100" v-if="openDateSelected && dataByDateDetail.length">
        <tr v-for="item,idx in dataByDateDetail" :key="idx"
          ...
          <td class="text-left border-1 border-gray-500 px-3">{{item.nama_lengkap}}</td>
           <td class="text-left border-1 border-gray-500 px-3">{{item.dir}}</td>
          <td class="text-left border-1 border-gray-500 px-3">{{item.divisi}}</td>
          ...
          <td class="text-left border-1 border-gray-500 px-3">
              <img v-if="item.absensi?.checkin_foto" :src="item.absensi?.checkin_foto" alt="Check In Photo" class="w-[auto] h-[100px] rounded-md object-center">
              <div v-else class="h-full bg-gray-500 w-[50px] rounded-[10px]"></div>
          </td>
          <td class="text-left border-1 border-gray-500 px-3">
            {{ item.absensi?.checkin_on_scope ? null : item.absensi.checkin_address }}
          </td>
          <td class="text-left border-1 border-gray-500 px-3 cursor-pointer"
          ...
          <td class="text-left border-1 border-gray-500 px-3">
              <img v-if="item.absensi?.checkout_foto" :src="item.absensi?.checkout_foto" alt="Check Out Photo" class="w-[auto] h-[100px] rounded-md object-center">
              <div v-else class="h-full bg-gray-500 w-[50px] rounded-[10px]"></div>
          </td>
          <td class="text-left border-1 border-gray-500 px-3">
            {{ item.absensi?.checkout_on_scope ? null : item.absensi.checkout_address }}
          </td>          <td class="text-center border-1 border-gray-500 px-3">
    ...
    <div class="grid grid-cols-8 md:grid-cols-12 text-[14px] gap-x-[29px] gap-y-[20px] px-[30px] py-[27px]">
      ...
      <div class="col-span-8 md:col-span-9 mt-2">
        <table>
          ...
          <tr class="font-semibold">
            <td class="w-[30%] py-1 px-2">Divisi </td>
            <td class="align-top py-1 px-1">:</td>
            <td class=" py-1 px-1">{{dataDetail.divisi}}</td>
          </tr>
          <tr>

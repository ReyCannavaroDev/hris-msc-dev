      ...
      <div class="grid <md:grid-cols-1 grid-cols-2 gap-2">
        ...
        <div>
         ...
         <div>
          ...
          <FieldPopup class="w-full !mt-0" :value="values.m_kary_id" @input="(v)=>values.m_kary_id=v"
        ...
        <table class="w-full overflow-x-auto table-auto border border-[#CACACA] " style="zoom: 80%">
          <thead>
            <tr class="border">
              ...
              <td class="text-[#8F8F8F] font-semibold text-[14px] text-capitalize px-2 text-center w-[12%] border bg-[#f8f8f8] border-[#CACACA]">ID Karyawan</td>
              ...
              <td class="text-[#8F8F8F] font-semibold text-[14px] text-capitalize px-2 text-center w-[12%] border bg-[#f8f8f8] border-[#CACACA]">Jabatan</td>
              <td class="text-[#8F8F8F] font-semibold text-[14px] text-capitalize px-2 text-center w-[12%] border bg-[#f8f8f8] border-[#CACACA]">Unit</td>

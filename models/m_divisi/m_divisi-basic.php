...
{   
    ...
    public $details     = [];
    public $heirs       = ["m_dept","m_kary","m_kary_det_kontrak","m_lembur","m_spd","m_standart_gaji","m_tunj_kemahalan","t_bonus","t_extend_kontrak","t_final_gaji_det","t_grup_kerja","t_jadwal_kerja","t_jadwal_kerja_det","t_mutasi","t_mutasi","t_pelamar","t_perhitungan_gaji","t_potongan_presensi","t_resign","t_spd"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];

...
{   
    ...
    public $details     = [];
    public $heirs       = ["m_kary","m_lembur","m_spd","m_standart_gaji","m_tunj_kemahalan","t_final_gaji_det","t_grup_kerja","t_jadwal_kerja","t_jadwal_kerja_det","t_loker","t_mutasi","t_mutasi","t_pelamar","t_perhitungan_gaji","t_potongan_presensi","t_spd"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];

...
{   
    ...
    public function m_kary_det_kontrak() :\HasMany
    {
        return $this->hasMany('App\Models\BasicModels\m_kary_det_kontrak', 'm_karyawan_id', 'id');
    }

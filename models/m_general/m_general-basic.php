...
{   
    ...
    public $details     = [];
    public $heirs       = ["m_jam_kerja","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary","m_kary_det_kartu","m_kary_det_kel","m_kary_det_kel","m_kary_det_kel","m_kary_det_kel","m_kary_det_org","m_kary_det_org","m_kary_det_pel","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pend","m_kary_det_pend","m_kary_det_pk","m_kary_det_pres","m_kary_det_kontrak","m_lembur","m_spd","m_spd_det_biaya","m_spd_det_transport","m_standart_gaji","m_tunj_kemahalan","presensi_m_menu_maksi_det","t_bonus","t_cuti","t_cuti","t_cuti_adjustment","t_extend_kontrak","t_final_gaji_det","t_jadwal_kerja","t_lembur","t_lembur","t_loker","t_loker","t_mutasi","t_pelamar","t_pelamar_det_kartu","t_pelamar_det_org","t_pelamar_det_org","t_pelamar_det_pel","t_pelamar_det_pend","t_pelamar_det_pend","t_pelamar_det_peng","t_pelamar_det_pk","t_pelamar_det_pres","t_perhitungan_gaji","t_potongan","t_potongan_presensi","t_resign","t_riwayat_posisi_det","t_riwayat_posisi_det","t_rpd_det","t_sgp","t_spd","t_spd_det"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];

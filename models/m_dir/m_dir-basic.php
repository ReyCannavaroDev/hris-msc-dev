...
{   
    ...
    public $details     = [];
    public $heirs       = ["default_users","generate_approval","generate_approval_log","m_approval","m_dept","m_divisi","m_file","m_general","m_jam_kerja","m_kary","m_kary_det_bhs","m_kary_det_kartu","m_kary_det_kel","m_kary_det_org","m_kary_det_pel","m_kary_det_pemb","m_kary_det_pend","m_kary_det_pk","m_kary_det_pres","m_knd_dinas","m_kary_det_kontrak","m_lembur","m_libur_nasional","m_lokasi","m_menu","m_pengguna","m_role","m_role_access","m_role_det","m_spd","m_spd_det_biaya","m_spd_det_transport","m_standart_gaji","m_tunj_kemahalan","m_zona","m_zona_det","t_bonus","t_cuti","t_cuti_adjustment","t_extend_kontrak","t_final_gaji_det","t_grup_kerja","t_hasil_tes","t_jadwal_kerja","t_jadwal_kerja_det","t_lembur","t_loker","t_mutasi","t_pelamar","t_perhitungan_gaji","t_potongan","t_potongan_presensi","t_resign","t_riwayat_posisi","t_sgp","t_spd"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [];

...
class tBonusTest extends TestCase
{
    ...
    public function testReadingData()
    {
        ...
        $this->call('GET', '/operation/t_bonus', $payload);
    ...
    public function testCreatingData()
    {
        ...
        $payload = [
		    ...
		    "jenis_bonus_id" => "bigint:required",
        ...
        $this->call('POST', '/operation/t_bonus', $payload);
        ...
        $this->seeInDatabase('t_bonus', array_filter($payload, function($dt){
            return !is_array($dt);
        } ));
    }
}
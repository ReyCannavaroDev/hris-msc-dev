...
{   
    ...
    public $heirs       = ["generate_approval","generate_approval","generate_approval","generate_approval_det","generate_approval_det","generate_approval_det","generate_approval_det","generate_approval_log","generate_approval_log","generate_approval_log","generate_num","generate_num","generate_num_det","generate_num_det","generate_num_log","generate_num_log","generate_num_type","generate_num_type","m_approval","m_approval","m_approval_det","m_approval_det","m_approval_det","m_blacklist","m_blacklist","m_comp","m_comp","m_contract","m_contract","m_dept","m_dept","m_dir","m_dir","m_divisi","m_divisi","m_file","m_file","m_general","m_general","m_jam_kerja","m_jam_kerja","m_jarak_kota","m_jarak_kota","m_kary","m_kary","m_kary_det_bhs","m_kary_det_bhs","m_kary_det_kartu","m_kary_det_kartu","m_kary_det_kel","m_kary_det_kel","m_kary_det_org","m_kary_det_org","m_kary_det_pel","m_kary_det_pel","m_kary_det_pemb","m_kary_det_pemb","m_kary_det_pend","m_kary_det_pend","m_kary_det_pk","m_kary_det_pk","m_kary_det_pres","m_kary_det_pres","m_knd_dinas","m_knd_dinas","m_lembur","m_lembur","m_libur_nasional","m_libur_nasional","m_lokasi","m_lokasi","m_menu","m_menu","m_pengesahan_doc","m_pengesahan_doc","m_pengguna","m_pengguna","m_pengguna","m_pengurangan_gaji","m_pengurangan_gaji","m_periode","m_periode","m_pph","m_pph","m_role","m_role","m_role_access","m_role_access","m_role_access","m_role_det","m_role_det","m_spd","m_spd","m_spd_det_biaya","m_spd_det_biaya","m_spd_det_transport","m_spd_det_transport","m_standart_gaji","m_standart_gaji","m_standart_gaji_det","m_standart_gaji_det","m_tunj_kemahalan","m_tunj_kemahalan","m_zona","m_zona","presensi_absensi","presensi_absensi","presensi_absensi","presensi_app_version","presensi_app_version","presensi_lokasi","presensi_lokasi","presensi_lokasi","presensi_m_menu_maksi","presensi_m_menu_maksi","presensi_m_menu_maksi_det","presensi_maksi","presensi_maksi","presensi_maksi_det","presensi_maksi_det","presensi_maksi_jadwal_ambil","presensi_maksi_jadwal_ambil","t_bonus","t_bonus","t_cuti","t_cuti","t_cuti_adjustment","t_cuti_adjustment","t_final_gaji","t_final_gaji","t_final_gaji_det","t_final_gaji_det","t_final_gaji_det_rincian","t_final_gaji_det_rincian","t_grup_kerja","t_grup_kerja","t_hasil_tes","t_hasil_tes","t_jadwal_kerja","t_jadwal_kerja","t_jadwal_kerja_det","t_jadwal_kerja_det","t_kary_salary_det_tarif","t_lembur","t_lembur","t_loker","t_loker","t_mutasi","t_mutasi","t_pelamar","t_pelamar","t_pelamar_det_pend","t_pelamar_det_pend","t_pelamar_det_peng","t_pelamar_det_peng","t_perhitungan_gaji","t_perhitungan_gaji","t_potongan","t_potongan","t_potongan_presensi","t_potongan_presensi","t_resign","t_resign","t_riwayat_posisi","t_riwayat_posisi","t_riwayat_posisi_det","t_riwayat_posisi_det","t_rpd","t_rpd","t_rpd_det","t_rpd_det","t_sgp","t_sgp","t_spd","t_spd","t_spd","t_spd_det","t_spd_det"];
    public $detailsChild= [];
    public $detailsHeirs= [];
    public $unique      = [
